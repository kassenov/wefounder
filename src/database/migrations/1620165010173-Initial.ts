...
export class Initial1620165010173 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "pitch_deck_upload" ("id" varchar PRIMARY KEY NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "filePath" text NOT NULL, "pitchDeckId" varchar)`);
        ...
        await queryRunner.query(`CREATE TABLE "pitch_deck_image" ("id" varchar PRIMARY KEY NOT NULL, "filePath" text NOT NULL, "pitchDeckId" varchar)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_pitch_deck_upload" ("id" varchar PRIMARY KEY NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "filePath" text NOT NULL, "pitchDeckId" varchar, CONSTRAINT "FK_470bcef37b3bebaea6bab658f79" FOREIGN KEY ("pitchDeckId") REFERENCES "pitch_deck" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_pitch_deck_upload"("id", "created_at", "filePath", "pitchDeckId") SELECT "id", "created_at", "filePath", "pitchDeckId" FROM "pitch_deck_upload"`);
        ...
        await queryRunner.query(`INSERT INTO "temporary_pitch_deck_image"("id", "filePath", "pitchDeckId") SELECT "id", "filePath", "pitchDeckId" FROM "pitch_deck_image"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pitch_deck_image" ("id" varchar PRIMARY KEY NOT NULL, "filePath" text NOT NULL, "pitchDeckId" varchar)`);
        await queryRunner.query(`INSERT INTO "pitch_deck_image"("id", "filePath", "pitchDeckId") SELECT "id", "filePath", "pitchDeckId" FROM "temporary_pitch_deck_image"`);
        ...
        await queryRunner.query(`CREATE TABLE "pitch_deck_upload" ("id" varchar PRIMARY KEY NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "filePath" text NOT NULL, "pitchDeckId" varchar)`);
        await queryRunner.query(`INSERT INTO "pitch_deck_upload"("id", "created_at", "filePath", "pitchDeckId") SELECT "id", "created_at", "filePath", "pitchDeckId" FROM "temporary_pitch_deck_upload"`);
